...
func TestUpdateEncryptPassphraseGolden(t *testing.T) {
	goldies := []encryptPassphraseGoldie{
		{
			"ok, no lot/sequence",
			[]byte{0xa5, 0x0d, 0xba, 0x67, 0x72, 0xcb, 0x93, 0x83},
			"TestingOneTwoThree",
			encryptPassphraseExpect{
				"passphrasepxFy57B9v8HtUsszJYKReoNDV6VHjUSGt8EVJmux9n1J3Ltf1gRxyDGXqnf9qm",
				false,
			},
		},
		...
		{
			"not enough entropy",
			[]byte{0xa5, 0x0d, 0xba, 0x67, 0x72, 0xcb, 0x93},
			"TestingOneTwoThree",
			encryptPassphraseExpect{"", true},
		},
	}
...
func TestUpdateEncryptPassphraseXGolden(t *testing.T) {
	goldies := []encryptPassphraseXGoldie{
		{
			"ok, with lot/sequence",
			[]byte{0x4f, 0xca, 0x5a, 0x97},
			"MOLON LABE",
			263183, 1,
			encryptPassphraseExpect{
				"passphraseaB8feaLQDENqCgr4gKZpmf4VoaT6qdjJNJiv7fsKvjqavcJxvuR1hy25aTu5sX",
